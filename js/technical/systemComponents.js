var systemComponents = {
	...
	'bg': {
		props: ['layer'],
		template: `<div class ="bg" v-bind:style="[(tmp[layer] && tmp[layer].style) ? tmp[layer].style : {}, (tmp[layer] && tmp[layer].tabFormat && !Array.isArray(tmp[layer].tabFormat) && player.subtabs[layer] && tmp[layer].tabFormat[player.subtabs[layer].mainTabs]) ? tmp[layer].tabFormat[player.subtabs[layer].mainTabs].style : {}]"></div>
		`
	}

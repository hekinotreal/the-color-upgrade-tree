...
function getPointGen() {
	...
	if (hasUpgrade("red", 17)) gain = gain.tetrate(1.2)
	if (hasUpgrade("red", 18)) gain = gain.tetrate(1.3)
	if (hasUpgrade("red", 19)) gain = gain.tetrate(1.4)
	if (hasUpgrade("red", 20)) gain = gain.tetrate(1.5)

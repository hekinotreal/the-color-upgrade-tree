...
function load() {
	...
	// Guard against saves referencing layers that no longer exist (e.g. after a rename)
	if (player.tab === undefined || !layers[player.tab]) player.tab = layoutInfo.startTab
	if (player.navTab !== "none" && (player.navTab === undefined || !layers[player.navTab])) player.navTab = layoutInfo.startNavTab
